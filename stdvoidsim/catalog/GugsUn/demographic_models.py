...
_vault_pop = stdvoidsim.Population(
    id="VaultDwellers", description="Gugs in the vaults of Zin"
)
_tower_pop = stdvoidsim.Population(
    id="TowerGugs", description="Gugs near the Tower of Koth"
)
    ...
    return stdvoidsim.DemographicModel(
        ...
        population_configurations=[
            msprime.PopulationConfiguration(
                initial_size=25000, metadata=populations[0].asdict()
            )
        ],
        demographic_events=[
            msprime.PopulationParametersChange(
                time=3000, initial_size=2000, population_id=0
            ),
            msprime.PopulationParametersChange(
...
def _tower_split():
    ...
    return stdvoidsim.DemographicModel(
        ...
        demographic_events=[
            ...
            msprime.PopulationParametersChange(
                time=10000, initial_size=200000, population_id=0
            ),
        ],
    )
