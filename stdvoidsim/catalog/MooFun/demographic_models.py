...
_dark_pop = stdvoidsim.Population(id="DarkSideMoon", description="Moon-beasts on the dark side of the moon")
_trade_pop = stdvoidsim.Population(id="TradeFleet", description="Moon-beast trading fleet in Dreamlands")
