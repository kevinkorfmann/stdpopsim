...
_citation = stdvoidsim.Citation(author="Gardner et al.", year=1927,
    doi="https://doi.org/10.1666/void.colour.1",
    reasons={stdvoidsim.CiteReason.GEN_TIME, stdvoidsim.CiteReason.POP_SIZE})
_assembly_citation = stdvoidsim.Citation(author="Gardner et al.", year=1927,
    doi="https://doi.org/10.1666/void.colour.2", reasons={stdvoidsim.CiteReason.ASSEMBLY})
_mutation_citation = stdvoidsim.Citation(author="Gardner et al.", year=1927,
...
_species = stdvoidsim.Species(id="ColOos", ensembl_id="chromatis_extraspatiala",
