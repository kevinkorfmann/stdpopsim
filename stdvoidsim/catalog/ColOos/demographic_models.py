...
_meteor_pop = stdvoidsim.Population(
    id="MeteorColony", description="Colour colony from meteorite impact"
)
_spread_pop = stdvoidsim.Population(
    id="EnvironSpread", description="Environmentally spread colour entities"
)
    ...
    return stdvoidsim.DemographicModel(
        ...
        demographic_events=[
            msprime.PopulationParametersChange(
                time=10000, initial_size=5, population_id=0
            ),
            msprime.PopulationParametersChange(
                time=100000, initial_size=1000, population_id=0
            ),
        ],
    )
...
def _well_spread():
    ...
    return stdvoidsim.DemographicModel(
        ...
        population_configurations=[
            msprime.PopulationConfiguration(
                initial_size=2000, metadata=populations[0].asdict()
            ),
            msprime.PopulationConfiguration(
        ...
        demographic_events=[
            msprime.PopulationParametersChange(
                time=1000, initial_size=10, population_id=1
            ),
