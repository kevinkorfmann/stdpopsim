...
_citation = stdvoidsim.Citation(author="Peaslee et al.", year=1935,
    doi="https://doi.org/10.1666/void.polyp.1",
    reasons={stdvoidsim.CiteReason.GEN_TIME, stdvoidsim.CiteReason.POP_SIZE})
_assembly_citation = stdvoidsim.Citation(author="Peaslee et al.", year=1935,
    doi="https://doi.org/10.1666/void.polyp.2", reasons={stdvoidsim.CiteReason.ASSEMBLY})
_mutation_citation = stdvoidsim.Citation(author="Peaslee et al.", year=1935,
...
_species = stdvoidsim.Species(id="FlyPol", ensembl_id="polypus_volantis",
