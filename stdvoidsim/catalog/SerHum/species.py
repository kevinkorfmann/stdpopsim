...
_citation = stdvoidsim.Citation(author="Kull et al.", year=1929,
    doi="https://doi.org/10.1666/void.serpent.1",
    reasons={stdvoidsim.CiteReason.GEN_TIME, stdvoidsim.CiteReason.POP_SIZE})
_assembly_citation = stdvoidsim.Citation(author="Kull et al.", year=1929,
    doi="https://doi.org/10.1666/void.serpent.2", reasons={stdvoidsim.CiteReason.ASSEMBLY})
_mutation_citation = stdvoidsim.Citation(author="Kull et al.", year=1929,
...
_species = stdvoidsim.Species(id="SerHum", ensembl_id="serpentis_valusiensis",
