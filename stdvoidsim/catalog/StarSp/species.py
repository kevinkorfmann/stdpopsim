...
_citation = stdvoidsim.Citation(author="Johansen et al.", year=1926,
    doi="https://doi.org/10.1666/void.starspawn.1",
    reasons={stdvoidsim.CiteReason.GEN_TIME, stdvoidsim.CiteReason.POP_SIZE})
_assembly_citation = stdvoidsim.Citation(author="Johansen et al.", year=1926,
    doi="https://doi.org/10.1666/void.starspawn.2", reasons={stdvoidsim.CiteReason.ASSEMBLY})
_mutation_citation = stdvoidsim.Citation(author="Johansen et al.", year=1926,
...
_species = stdvoidsim.Species(id="StarSp", ensembl_id="starspawn_cthulhidae",
